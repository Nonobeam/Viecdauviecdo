...
const CompactSubscriptionCard = ({
  ...
  const getPlanIcon = (planId) => {
    switch (planId) {
      case "matchlent-premium":
        return <Crown className="h-4 w-4 text-yellow-500" />;
      case "matchlent-platinum":
      case "matchlent-ads":
        ...
        <Card className="border-0 shadow-sm">
          ...
          <CardContent className="space-y-4">
                ...
                <ul className="space-y-2 mb-4">
                  ...
                  {plan.benefits.length > 2 && (
                    <li className="text-xs text-gray-500 pl-6">
                      +{plan.benefits.length - 2} tính năng khác
                    </li>
                  )}
                </ul>
            ...
            {availableUpgrades.length > 2 && (
              <Button
                variant="outline"
                className="w-full mt-2 border-gray-300 hover:bg-gray-50 text-gray-700"
