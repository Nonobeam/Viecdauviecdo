...
export const plans = [
  {
    ...
    price: "0",
    period: "Mãi mãi",
    description: "Ideal for exploring opportunities",
    popular: false,
    benefits: [
      "Đăng hồ sơ cá nhân, CV ứng tuyển",
      "Tìm kiếm việc làm",
      "Nộp hồ sơ ứng tuyển",
      "Đăng blog chia sẻ trải nghiệm, kiến thức",
      "Tham gia miễn phí 3 dự án/tháng",
    ],
  ...
  },
  {
    ...
    benefits: [
      ...
      "Đăng blog chia sẻ trải nghiệm, kiến thức",
      "Tham gia miễn phí 3 dự án/tháng",
      "Ưu tiên hiển thị hồ sơ ở đầu danh sách tìm kiếm",
      "Tăng tỉ lệ được xem",
      "Không giới hạn số dự án được tham gia",
    ],
    buttonText: "Đăng ký ngay",
  ...
  },
  {
    ...
    benefits: [
      ...
      "Tăng tỉ lệ được xem",
      "Không giới hạn số dự án được tham gia",
      "Dự án được ưu tiên hiển thị trên trang chủ",
      "Được gắn nhãn 'Dự án nổi bật'",
      "Tạo lộ trình kỹ năng, kinh nghiệm bằng Mindmap",
      "Gợi ý kỹ năng cần có cho các vị trí khác nhau",
      "Tạo bảng so sánh các JD đã lưu",
    ],
    buttonText: "Đăng ký ngay",
  ...
  {
    id: "matchlent-basic",
    name: "Matchlent Basic",
    price: "300000",
    discountedPrice: "199000",
    period: "mỗi tháng",
    description: "Gói cơ bản cho doanh nghiệp tuyển dụng",
    popular: false,
    benefits: [
      "Nhận hồ sơ không giới hạn",
      "Đăng 8 tin miễn phí",
      "Gợi ý ứng viên khớp với JD",
      "Gợi ý thời điểm tốt nhất để đăng/tối ưu tin tuyển",
    ],
    buttonText: "Đăng ký ngay",
  ...
  {
    id: "matchlent-elite",
    name: "Matchlent Elite",
    price: "500000",
    discountedPrice: "390000",
    period: "mỗi tháng",
    description: "Nâng cấp tuyển dụng với ưu tiên cao",
    popular: false,
    benefits: [
      "Nhận hồ sơ không giới hạn",
      "Đăng 8 tin miễn phí",
      "Gợi ý ứng viên khớp với JD",
      "Gợi ý thời điểm tốt nhất để đăng/tối ưu tin tuyển",
      "Ưu tiên hiển thị tin tuyển dụng ở đầu danh sách tìm kiếm",
      "Không giới hạn số dự án được tạo",
      "Chọn lọc và gợi ý ứng viên khớp với JD",
      "Tăng tỷ lệ click và CV nhận về",
    ],
    buttonText: "Đăng ký ngay",
    buttonStyle: "bg-purple-600 hover:bg-purple-700 text-white",
  },
  {
    id: "matchlent-platinum",
    name: "Matchlent Platinum",
    price: "800000",
    discountedPrice: "690000",
    period: "mỗi tháng",
    description: "Gói cao cấp với thương hiệu và phân tích chuyên sâu",
    popular: true,
    benefits: [
      "Nhận hồ sơ không giới hạn",
      "Đăng 8 tin miễn phí",
      ...
      "Chọn lọc và gợi ý ứng viên khớp với JD",
      "Tăng tỷ lệ click và CV nhận về",
      "Tạo thương hiệu tuyển dụng trên nền tảng",
      "Không giới hạn số lượng đăng tin tuyển dụng",
      "Không giới hạn số lượt đăng bài lên blog",
      "So sánh tin tuyển với các tin cùng ngành, khu vực",
    ],
    buttonText: "Đăng ký ngay",
  ...
  },
  {
    ...
    period: "mỗi tháng",
    description: "Quảng bá thương hiệu và tin tuyển dụng",
    popular: false,
    benefits: [
      "Đặt logo, nhận diện thương hiệu trên các nền tảng của Matchlent",
      "Quảng cáo tin tuyển dụng uy tín",
    ],
    buttonText: "Đăng ký ngay",
